...
void MoreTests() {
  ...
  std::cout<<std::endl;
  std::cout<<"UnrolledLL a:"<<std::endl;
  UnrolledLL<int> a;
  a.push_back(1);
  a.push_back(2);
  a.push_back(3);
  ...
  a.print(std::cout);
  std::cout<<std::endl;
  std::cout<<"UnrolledLL b:"<<std::endl;
  UnrolledLL<int> b(a);
  b.print(std::cout);
  ...
  a.print(std::cout);
  std::cout<<std::endl;
  std::cout<<"UnrolledLL c:"<<std::endl;
  UnrolledLL<int> c;
  c = a;
  c.print(std::cout);
  ...
  UnrolledLL<int>::iterator a_iter = a.begin();
  while (a_iter!=a.end()){
    std::cout<<" itr "<<*a_iter<<std::endl;
    a_iter++;
  }
  std::cout<<std::endl;

  //Testing different types. Used string as example
  std::cout<<"Testing types: "<<std::endl;
  UnrolledLL<string> str; 
  str.push_back("Lizard");
  str.push_back("Dog");
  str.push_back("Elephant");
  str.push_back("Cat");
  str.push_back("Monkey");
  str.push_back("Tiger");
  str.push_back("Beaver");
  str.push_back("Rhino");
  str.push_back("Bird");
  str.print(std::cout);
  ...
  str.pop_back();
  str.print(std::cout);
  std::cout<<"Pushing front 'Cow'"<<std::endl;
  str.push_front("Cow");
  str.print(std::cout);
