...
void RealTreeTestNoPrint(ofstream& outfile);
...
int main(int argc, char* argv[]){
	...
	TemplateTest();
	cout << "TemplateTest() complete!" << std::endl << std::endl;

	SmallTreeCopyTest();
	cout << "SmallTreeCopyTest() complete!" << std::endl << std::endl;

	EmptyTreeTest(outfile);
	cout << "EmptyTreeTest() complete!" << std::endl << std::endl;

	RealTreeTestNoPrint(outfile);
	cout << "RealTreeTestNoPrint() complete!" << std::endl << std::endl;

	RealTreeTestPrint(outfile);
	cout << "RealTreeTestPrint() complete!" << std::endl;
...
void SmallTreeCopyTest(){
	...
	assert(b2.find(4)->contains(3)); //crashes here
...
void RealTreeTestNoPrint(ofstream& outfile){
	...
	//b1.print_BFS(outfile); not here before just testing
