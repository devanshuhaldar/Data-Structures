...
void StudentTests() {
//Testing string jagged array
  JaggedArray<string> str(5);
  str.addElement(1,"Hello");
  str.addElement(0,"World");
  str.addElement(0,"Jagged");
  str.addElement(0,"Array");
  str.addElement(4,"Testing");

//Testing integer jagged array
  JaggedArray<int> i(4);
  i.addElement(0,3);
  i.addElement(1,11);
  i.addElement(1,-1);
...
//Testing double jagged array
  JaggedArray<double> d(5);
  d.addElement(2,1.1);
  d.addElement(0,2.6);
  d.addElement(3,53.1);
  d.addElement(0,1.0);
